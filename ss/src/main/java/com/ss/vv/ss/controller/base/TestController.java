...
public class TestController {
	...
	@ResponseBody
	public WebResponse addOrEditTest(HttpServletRequest request, HttpServletResponse response, HttpSession session, String testId, @RequestParam(required = false) String testName, @RequestParam(required = false) String info, @RequestParam(required = false) String other) {
	...
	@ResponseBody
	public WebResponse addTest(HttpServletRequest request, HttpServletResponse response, HttpSession session, String testName, String info, String other) {
		Object data = null;
		String statusMsg = "";
		...
		data = paramMap;
		if (testName == null || "".equals(testName.trim()) || info == null || "".equals(info.trim()) || other == null || "".equals(other.trim())) {
			statusMsg = " 参数为空错误！！！！";
			statusCode = 201;
	...
	@ResponseBody
	public WebResponse editTest(HttpServletRequest request, HttpServletResponse response, HttpSession session, String testId, @RequestParam(required = false) String testName, @RequestParam(required = false) String info, @RequestParam(required = false) String other) {
		Object data = null;
		String statusMsg = "";
		Integer statusCode = 200;
		Map<String, String> paramMap = new HashMap<String, String>();
 ...
 * 
 */
private WebResponse addOrEditTest(HttpServletRequest request, HttpServletResponse response, HttpSession session, Object data, Test test, String testName, String info, String other, boolean isAdd) {
		String statusMsg = "";
		Integer statusCode = 200;
